...
# 2.Create EC2 that is installed LAMP with user data seen below for
# "Wordpress app in Public Subnet 1b"
...
# 6. To connect to private instance first we need to connect from a public instance.
#  Let's try the Wordpress Instance.
...
# 16. Select Nat instance, click Networking from the Actions menu and then go 
#to Change Source/Destination Check.
